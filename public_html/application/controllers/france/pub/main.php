...
class Main extends CI_Controller {
    ...
    public function index()
    {
    	...
    	$path = (uri_string() === 'france/pub' OR uri_string() === 'france/pub/m')?'france/pub/tutorial':uri_string();

    	if (( ! empty($exception) && ($exception === 'head' OR $exception === 'all')) OR $path === 'france/pub/tutorial')
    	{
    		// do not include the header file.
    	}
    	else
    	{
	    	$this->load->view($lang.'france/common/header', $data);
    	}

    	if ($path){$this->load->view($path);}

    	if (( ! empty($exception) && ($exception === 'foot' OR $exception === 'all')) OR $path === 'france/pub/tutorial')
    	{
    		// do not include the footer file.
    	}
    	else
    	{
	    	$this->load->view($lang.'france/common/footer', $data);
    	}
    }
    ...
    public function m()
    {
    	...
    	else
    	{
            ...
            $this->load->view($lang.'france/m/common/header', $data);
    	}
    	...
    	else
    	{
            ...
            $this->load->view($lang.'france/m/common/footer', $data);
    	}
    }
}
