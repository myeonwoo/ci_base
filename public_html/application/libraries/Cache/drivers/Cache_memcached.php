...
class Cache_memcached extends CI_Driver {
	...
	//cache key
	private $key_prefix = 'prodangicokr';
    ...
    public function get_cache_key($class, $function, $func_get_args) {

        $cacheKey = $class. ":" . $function;
        if (isset($this->key_prefix)) {
            $cacheKey = $this->key_prefix . ":" . $cacheKey;
        }
//        foreach ($func_get_args as $item) {
//            $cacheKey .= ":" . $item;
//        }

        $serialized_args = serialize($func_get_args);
        if ($serialized_args) {
            $cacheKey = $cacheKey . ":" . addslashes($serialized_args);
        }
